...
class FileManagerTest extends TestBase {
	...
	test("file manager - rename dir") { f =>
	...
	test("file manager - download nonexistent") { f =>
	...
	test("file manager - rename file") { f =>
	...
	test("file manager - get countent") { f =>
