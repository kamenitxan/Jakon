 ...
 * Platební metoda
 */
class PaymentMethod extends JakonObject with Serializable {
...
object PaymentMethod {
	val objectSettings: ObjectSettings = new ObjectSettings(icon = "fa-credit-card")
}
